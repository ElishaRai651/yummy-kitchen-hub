...
public class StaffPage {
    ...
    private void prepareGUI() {
        ...
        StaffPage.MenuListener menuListener = new StaffPage.MenuListener();
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            switch (command) {
                ...
                case "Back":
                    ...
                    HomePage homePage = new HomePage(); // Go back to the OpeningPage if applicable
                    break;
                case "Exit":
    ...
    public void showButtonDemo() {
        ...
        createButton("Order Placement", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //showMessage("Order Placement button clicked!");
    ...
    private void createButton(String buttonText, ActionListener actionListener) {
        ...
        button.setPreferredSize(new Dimension(220, 70)); // Increased button size
