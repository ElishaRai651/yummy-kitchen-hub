...
public class AdminPage {
    ...
    private void prepareGUI() {
        ...
        AdminPage.MenuListener menuListener = new AdminPage.MenuListener();
    ...
    public void showButtonDemo() {
        createButton("Items Modify", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //showMessage("Items Modify button clicked!");
                ItemModify itemModify = new ItemModify();
            }
        });

        createButton("Staffs Info", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //showMessage("Staffs Info button clicked!");
                StaffInfo staffInfo = new StaffInfo();
            }
        });

        createButton("Items Info", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
               // showMessage("Items Info button clicked!");
                ItemInfo itemInfo = new ItemInfo();
            }
        });

        createButton("Sales Report", new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                showMessage("Sales Report button clicked!");
                OrderReportExample orderReportExample = new OrderReportExample();
            }
        });
